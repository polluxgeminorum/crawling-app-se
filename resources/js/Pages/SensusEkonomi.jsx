                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {indicators.map((indicator, index) => (
                            <div key={index} className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100 text-center">
                        ...
                        {stages.map((stage, index) => (
                            <div key={index} className="bg-white rounded-xl p-6 shadow-md border border-slate-100 flex flex-col md:flex-row md:items-center justify-between">
                                ...
                                <div className="text-right">
                                    <span className="inline-block px-4 py-2 bg-blue-50 text-blue-700 rounded-lg text-sm font-medium">
                                        {stage.date}
                                    </span>
                                </div>
                            </div>
